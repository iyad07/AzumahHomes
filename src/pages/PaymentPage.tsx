...
const PaymentPage = () => {
  ...
  // Filter cart items to only show rental properties
  const rentalProperties = cartItems.filter(item => item.property.tag === 'For Rent');
  
  // Calculate total rent amount
  const totalAmount = rentalProperties.reduce((total, item) => total + item.property.price, 0);
  ...
  // Redirect if no rental properties in cart
  useEffect(() => {
    if (rentalProperties.length === 0) {
      toast.error('No rental properties in your cart');
      navigate('/dashboard/cart');
    }
  }, [rentalProperties, navigate]);
  ...
  return (
    <div className="pt-32 pb-20 min-h-screen">
      <div className="container mx-auto px-4">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 md:mb-6 lg:mb-8">Complete Your Rental Payment</h1>
          ...
          <div className="order-first lg:order-last lg:col-span-1">
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>Review your rental properties</CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="pt-4 space-y-2">
                  ...
                  <div className="flex justify-between font-bold pt-2 border-t border-gray-200 text-sm md:text-base">
                    ...
                    <span>{formatPrice(totalAmount * 2 + 50)}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="order-last lg:order-first lg:col-span-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Enter your payment information to complete your rental</CardDescription>
              </CardHeader>
