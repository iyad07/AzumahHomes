...
import { Link, NavLink, useLocation } from "react-router-dom";0
...
const Header = () => {
  ...
  >
      <div className="px-0.5">
        ...
        <div
          className={cn(
            "hidden lg:flex justify-between items-center text-sm mb-2 transition-opacity duration-300 border-b-[0.5px] border-black/30 pb-1",
        ...
        >
          <img src="/logo.png" alt="Logo" className="w-10 h-5 lg:w-14 lg:h-10 ml-4" />
